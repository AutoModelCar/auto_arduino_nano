#ifndef _ROS_autonomos_stereo_camera_msgs_PackedDisparityImage_h
#define _ROS_autonomos_stereo_camera_msgs_PackedDisparityImage_h
...
namespace autonomos_stereo_camera_msgs
{
  ...
  class PackedDisparityImage : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "autonomos_stereo_camera_msgs/PackedDisparityImage"; };
