#ifndef _ROS_ibeo_sdk_measurement_msgs_Measurement_2281_h
#define _ROS_ibeo_sdk_measurement_msgs_Measurement_2281_h
...
namespace ibeo_sdk_measurement_msgs
{
  ...
  class Measurement_2281 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ibeo_sdk_measurement_msgs/Measurement_2281"; };
