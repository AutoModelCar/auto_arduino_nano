#ifndef _ROS_fub_trajectory_msgs_Trajectory_h
#define _ROS_fub_trajectory_msgs_Trajectory_h
...
namespace fub_trajectory_msgs
{
  ...
  class Trajectory : public ros::Msg
  {
    public:
      ...
      typedef fub_trajectory_msgs::TrajectoryPoint _trajectory_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(trajectory_lengthT > trajectory_length)
        this->trajectory = (fub_trajectory_msgs::TrajectoryPoint*)realloc(this->trajectory, trajectory_lengthT * sizeof(fub_trajectory_msgs::TrajectoryPoint));
      trajectory_length = trajectory_lengthT;
      for( uint32_t i = 0; i < trajectory_length; i++){
      offset += this->st_trajectory.deserialize(inbuffer + offset);
        memcpy( &(this->trajectory[i]), &(this->st_trajectory), sizeof(fub_trajectory_msgs::TrajectoryPoint));
      }
     return offset;
    }

    const char * getType(){ return "fub_trajectory_msgs/Trajectory"; };
    const char * getMD5(){ return "c25a841ab3a41a9903c2c454744a12f1"; };
