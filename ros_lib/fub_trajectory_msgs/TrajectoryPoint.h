#ifndef _ROS_fub_trajectory_msgs_TrajectoryPoint_h
#define _ROS_fub_trajectory_msgs_TrajectoryPoint_h
...
namespace fub_trajectory_msgs
{
  ...
  class TrajectoryPoint : public ros::Msg
  {
    ...
    const char * getType(){ return "fub_trajectory_msgs/TrajectoryPoint"; };
