#ifndef _ROS_fub_pointcloud_msgs_VelodyneObstacle_h
#define _ROS_fub_pointcloud_msgs_VelodyneObstacle_h
...
namespace fub_pointcloud_msgs
{
  ...
  class VelodyneObstacle : public ros::Msg
  {
    public:
      ...
      typedef geometry_msgs::Point _bounding_box_center_type;
      ...
      typedef geometry_msgs::Point _object_box_center_type;
      _object_box_center_type object_box_center;
      typedef geometry_msgs::Point _object_box_sigma_type;
      ...
      typedef geometry_msgs::Vector3 _reference_point_sigma_type;
      _reference_point_sigma_type reference_point_sigma;
      typedef geometry_msgs::Point _closest_point_type;
      ...
      typedef geometry_msgs::Vector3 _absolute_velocity_type;
      _absolute_velocity_type absolute_velocity;
      typedef geometry_msgs::Vector3 _absolute_velocity_sigma_type;
      _absolute_velocity_sigma_type absolute_velocity_sigma;
      typedef geometry_msgs::Vector3 _relative_velocity_type;
      _relative_velocity_type relative_velocity;
      typedef geometry_msgs::Vector3 _relative_velocity_sigma_type;
    ...
    const char * getType(){ return "fub_pointcloud_msgs/VelodyneObstacle"; };
    const char * getMD5(){ return "841480bfcf4ee20930974e6532d89532"; };
