#ifndef _ROS_fub_pointcloud_msgs_PointCloudVector_h
#define _ROS_fub_pointcloud_msgs_PointCloudVector_h
...
namespace fub_pointcloud_msgs
{
  ...
  class PointCloudVector : public ros::Msg
  {
    public:
      uint32_t objects_length;
      typedef sensor_msgs::PointCloud2 _objects_type;
    ...
    const char * getType(){ return "fub_pointcloud_msgs/PointCloudVector"; };
